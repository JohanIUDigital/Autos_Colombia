		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#iudigitalautoscolombia-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iudigitalautoscolombia-display": {
								"semanticObject": "iudigitalautoscolombia",
								"action": "display",
								"description": "Evidencia de Aprendizaje Ingenieria de Software IU Digital",
								"title": "Autos Colombia",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iu.digital.autoscolombia",
									"url": sap.ui.require.toUrl("iu/digital/autoscolombia")
								}
							}
						}
					}
